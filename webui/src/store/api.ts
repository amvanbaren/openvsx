...
export const apiSlice = createApi({
    ...
    endpoints: builder => ({
        ...
        getExtensions: builder.query<Readonly<Extension[] | ErrorResult>, void>({
            query: () => ({
                url: '/user/extensions',
                credentials: 'include'
            }),
