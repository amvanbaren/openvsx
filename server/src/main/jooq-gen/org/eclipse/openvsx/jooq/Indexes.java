...
public class Indexes {
    ...
    public static final Index JR_JOBRUNR_BGJOBSRVRS_FSTHB_IDX = Internal.createIndex(DSL.name("jr_jobrunr_bgjobsrvrs_fsthb_idx"), JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS, new OrderField[] { JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS.FIRSTHEARTBEAT }, false);
    public static final Index JR_JOBRUNR_BGJOBSRVRS_LSTHB_IDX = Internal.createIndex(DSL.name("jr_jobrunr_bgjobsrvrs_lsthb_idx"), JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS, new OrderField[] { JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS.LASTHEARTBEAT }, false);
    public static final Index JR_JOBRUNR_JOB_CREATED_AT_IDX = Internal.createIndex(DSL.name("jr_jobrunr_job_created_at_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.CREATEDAT }, false);
    public static final Index JR_JOBRUNR_JOB_RCI_IDX = Internal.createIndex(DSL.name("jr_jobrunr_job_rci_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.RECURRINGJOBID }, false);
    public static final Index JR_JOBRUNR_JOB_SCHEDULED_AT_IDX = Internal.createIndex(DSL.name("jr_jobrunr_job_scheduled_at_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.SCHEDULEDAT }, false);
    public static final Index JR_JOBRUNR_JOB_SIGNATURE_IDX = Internal.createIndex(DSL.name("jr_jobrunr_job_signature_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.JOBSIGNATURE }, false);
    public static final Index JR_JOBRUNR_JOB_UPDATED_AT_IDX = Internal.createIndex(DSL.name("jr_jobrunr_job_updated_at_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.UPDATEDAT }, false);
    public static final Index JR_JOBRUNR_STATE_IDX = Internal.createIndex(DSL.name("jr_jobrunr_state_idx"), JrJobrunrJobs.JR_JOBRUNR_JOBS, new OrderField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.STATE }, false);
