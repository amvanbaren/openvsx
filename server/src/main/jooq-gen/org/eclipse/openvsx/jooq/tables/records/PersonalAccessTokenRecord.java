...
public class PersonalAccessTokenRecord extends UpdatableRecordImpl<PersonalAccessTokenRecord> implements Record7<Long, LocalDateTime, Boolean, LocalDateTime, String, String, String> {
    ...
    /**
     * Setter for <code>public.personal_access_token.user_id</code>.
     */
    ...
    /**
     * Getter for <code>public.personal_access_token.user_id</code>.
     */
    ...
    @Override
    public Row7<Long, LocalDateTime, Boolean, LocalDateTime, String, String, String> valuesRow() {
    ...
    public Field<String> field7() {
        return PersonalAccessToken.PERSONAL_ACCESS_TOKEN.USER_ID;
    }
    ...
    @Override
    public PersonalAccessTokenRecord value7(String value) {
        setUserId(value);
        return this;
    }

    @Override
    public PersonalAccessTokenRecord values(Long value1, LocalDateTime value2, Boolean value3, LocalDateTime value4, String value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PersonalAccessTokenRecord(Long id, LocalDateTime accessedTimestamp, Boolean active, LocalDateTime createdTimestamp, String description, String value, String userId) {
        super(PersonalAccessToken.PERSONAL_ACCESS_TOKEN);
