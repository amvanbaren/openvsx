...
public class Keys {
    ...
    public static final UniqueKey<PublisherAgreementRecord> PUBLISHER_AGREEMENT_PKEY = Internal.createUniqueKey(PublisherAgreement.PUBLISHER_AGREEMENT, DSL.name("publisher_agreement_pkey"), new TableField[] { PublisherAgreement.PUBLISHER_AGREEMENT.ID }, true);
