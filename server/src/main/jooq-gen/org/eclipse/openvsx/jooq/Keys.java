...
import org.eclipse.openvsx.jooq.tables.records.JrJobrunrBackgroundjobserversRecord;
import org.eclipse.openvsx.jooq.tables.records.JrJobrunrJobsRecord;
import org.eclipse.openvsx.jooq.tables.records.JrJobrunrMetadataRecord;
import org.eclipse.openvsx.jooq.tables.records.JrJobrunrMigrationsRecord;
import org.eclipse.openvsx.jooq.tables.records.JrJobrunrRecurringJobsRecord;
...
public class Keys {
    ...
    public static final UniqueKey<JrJobrunrBackgroundjobserversRecord> JR_JOBRUNR_BACKGROUNDJOBSERVERS_PKEY = Internal.createUniqueKey(JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS, DSL.name("jr_jobrunr_backgroundjobservers_pkey"), new TableField[] { JrJobrunrBackgroundjobservers.JR_JOBRUNR_BACKGROUNDJOBSERVERS.ID }, true);
    public static final UniqueKey<JrJobrunrJobsRecord> JR_JOBRUNR_JOBS_PKEY = Internal.createUniqueKey(JrJobrunrJobs.JR_JOBRUNR_JOBS, DSL.name("jr_jobrunr_jobs_pkey"), new TableField[] { JrJobrunrJobs.JR_JOBRUNR_JOBS.ID }, true);
    public static final UniqueKey<JrJobrunrMetadataRecord> JR_JOBRUNR_METADATA_PKEY = Internal.createUniqueKey(JrJobrunrMetadata.JR_JOBRUNR_METADATA, DSL.name("jr_jobrunr_metadata_pkey"), new TableField[] { JrJobrunrMetadata.JR_JOBRUNR_METADATA.ID }, true);
    public static final UniqueKey<JrJobrunrMigrationsRecord> JR_JOBRUNR_MIGRATIONS_PKEY = Internal.createUniqueKey(JrJobrunrMigrations.JR_JOBRUNR_MIGRATIONS, DSL.name("jr_jobrunr_migrations_pkey"), new TableField[] { JrJobrunrMigrations.JR_JOBRUNR_MIGRATIONS.ID }, true);
    public static final UniqueKey<JrJobrunrRecurringJobsRecord> JR_JOBRUNR_RECURRING_JOBS_PKEY = Internal.createUniqueKey(JrJobrunrRecurringJobs.JR_JOBRUNR_RECURRING_JOBS, DSL.name("jr_jobrunr_recurring_jobs_pkey"), new TableField[] { JrJobrunrRecurringJobs.JR_JOBRUNR_RECURRING_JOBS.ID }, true);
